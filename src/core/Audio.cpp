...
{
public:
    static int volumeCallback(vlc_object_t */*obj*/, const char */*name*/, vlc_value_t /*oldVal*/, vlc_value_t newVal, void *data)
    {
    ...
    static int muteCallback(vlc_object_t */*obj*/, const char */*name*/, vlc_value_t /*oldVal*/, vlc_value_t newVal, void *data)
    {
        VlcAudio *core = (VlcAudio *)data;
